...
import com.onthego.onthegovisitation.viewmodel.CustomerViewModel
 ...
 * 12.6.2019
 */
class CustomerListFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        val addCusItem=menu.findItem(R.id.action_new_customer)
        addCusItem.isVisible = false
...
//            }
    ...
    override fun onCreateView(
        ...
        customerViewModel = ViewModelProviders.of(activity!!).get(CustomerViewModel::class.java)
    ...
    private fun loadCustomerInfo() {
        ...
        customerViewModel.getCustomerList(companyId, deviceId, userId).observe(activity!!, Observer {
            refreshLayout.isRefreshing = false
