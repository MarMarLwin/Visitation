...
public class IndexBarRecyclerViewSection extends RecyclerView.AdapterDataObserver {
    ...
    public IndexBarRecyclerViewSection(Context context, IndexBarRecyclerView rv) {

        setIndexTextSize = rv.setIndexTextSize;
        setIndexbarWidth = rv.mIndexbarWidth;
        setIndexbarMargin = rv.mIndexbarMargin;
        setIndexbarMarginTop = rv.mIndexbarMarginTop;
        setIndexbarMarginBottom = rv.mIndexbarMarginBottom;
        ...
        mIndexbarMarginTop = setIndexbarMarginBottom * mDensity;
        mIndexbarMarginTop = setIndexbarMarginBottom * mDensity;
